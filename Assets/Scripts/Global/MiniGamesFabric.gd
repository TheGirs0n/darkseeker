...
@export var mini_game_wire_scene : MiniGameWire
...
@export var mini_game_image_scene : MiniGameImage
...
@export var mini_game_code_scene : MiniGameCode
...
func get_by_difficulty(difficulty : GlobalEnums.BotDifficulty) -> MiniGamesConfig:
	match difficulty:
...
func get_random_minigame(difficulty : GlobalEnums.BotDifficulty) -> MiniGamesBase:
